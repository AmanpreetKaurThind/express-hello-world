...
app.get('/api/hikari/bot/bypass', async (req, res) => {
    ...
    try {
      ...
      const apiKey = "Shouko_Hub_5c2f8e9a-c3db4701ab-43e2e10-5c2a2";
      const baseUrl = "https://selected-physically-sunbeam.ngrok-free.app/";
...
app.listen(port, () => {
  console.log(`ethos api now running at: http://localhost:${port}`);
});
